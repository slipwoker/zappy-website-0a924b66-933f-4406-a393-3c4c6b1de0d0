document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input === nameInput && !value) {
                showError(input, 'الاسم مطلوب');
                return false;
            }
            ...
            if (input === emailInput && !value) {
                showError(input, 'البريد الإلكتروني مطلوب');
                return false;
            }
            ...
            if (input === messageInput && !value) {
                showError(input, 'الرسالة مطلوبة');
                return false;
            }
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                .catch(function() {
                    ...
                    errorMessage.className = 'form-error form-global-error';
    ...
    if (animatedElements.length > 0) {
        ...
        function handleScrollAnimations() {
            animatedElements.forEach(function(element) {
                if (isElementInViewport(element, 80)) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0a924b66-933f-4406-a393-3c4c6b1de0d0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0a924b66-933f-4406-a393-3c4c6b1de0d0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0a924b66-933f-4406-a393-3c4c6b1de0d0';
